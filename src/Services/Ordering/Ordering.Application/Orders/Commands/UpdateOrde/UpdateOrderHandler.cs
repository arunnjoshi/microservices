namespace Ordering.Application.Orders.Commands.UpdateOrde;

public class UpdateOrderHandler(IApplicationDbContext _context) : ICommandHandler<UpdateOrderCommand, UpdateOrderResult>
{
